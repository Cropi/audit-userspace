...
extern int neg_event_id;
extern gid_t event_gid, event_egid;
extern int neg_event_gid, neg_event_egid;
extern pid_t event_pid;
extern int neg_event_pid, neg_event_ppid;
extern int event_exact_match;
extern uid_t event_uid, event_euid, event_loginuid;
extern int neg_event_uid, neg_event_euid, neg_event_loginuid;
extern const char *event_tuid, *event_teuid, *event_tauid;
extern int neg_event_tuid, neg_event_teuid, neg_event_tauid;
extern slist *event_node_list;
extern int neg_event_node;
extern const char *event_comm;
extern int neg_event_comm;
extern const char *event_filename;
extern int neg_event_filename;
extern const char *event_hostname;
extern int neg_event_hostname;
extern const char *event_terminal;
extern int neg_event_terminal;
extern int event_syscall;
extern int neg_event_syscall;
extern int event_machine;
extern int neg_event_machine;
extern const char *event_exe;
extern int neg_event_exe;
extern int event_ua, event_ga;
extern long long event_exit;
extern int event_exit_is_set;
extern int neg_event_exit;
extern const char *event_uuid;
extern int neg_event_uuid;
extern const char *event_vmname;
extern int neg_event_vmname;
extern int neg_event_success;
